...
A different kind of report is the [budget breakdown]({{< relref "/reports/index/#budget-breakdown" >}}) wich shows the [company budget]({{< relref "/profit-loss/#index.md" >}}) compared to the projected [revenues]({{< relref "/revenues/#index.md" >}}) for the current year. The projected revenues are divided into production coming form the projects in pipeline, revenues bluesky and the remaining [delta revenue target]({{< relref "/profit-loss/#index.md" >}}). 
