...
* **People allocation**:
    ...
    * **Highlight weekends**: display Saturdays and Sundays in People Allocation using a special pattern and show a warning when user tries to allocate on these days ([learn more]()). This feature can be enabled only if "Use 7-days week calendar" is enabled too
