...
For each month, under the production's percentage you can see the production value of that percentage, that is the percentage applied to the _weighted production generated by the project_. 

Let's do an example: if "Project A" has a final net of 100.000 with a probability of 10% its weighted production is 10.000, if you're planning to produce 70% of 10.000 on June this means that you are pretty confident to work for 7.000.
...
{{< img-center src="/uploads/2019/06/19/production-plan.png">}}